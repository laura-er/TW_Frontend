...
import AddBookModal, { BookFormData } from '@/app/components/profile/AddBookModal';
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" key={activeTab}>
                    ...
                    {activeTab === "myBooks" && (
                        <button 
                            ...
                            className="group relative overflow-hidden rounded-2xl border-2 border-dashed border-warmBrown/30 dark:border-slate-600 bg-white dark:bg-slate-800 p-8 text-center transition-all duration-300 hover:border-warmOrange hover:bg-warmOrange/5 dark:hover:bg-warmOrange/10 min-h-[300px] flex items-center justify-center"
                        >
