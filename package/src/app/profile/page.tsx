...
import EditProfileModal from "@/app/components/shared/EditProfileModal";
import ShareProfileModal from "@/app/components/shared/ShareProfileModal";
import { CURRENT_USER } from "@/lib/usersConfig";
...
export default function ProfilePage() {
    ...
    // State pentru currentUser pentru a permite editarea
    ...
    const handleSaveProfile = (updatedUser: { name: string; email: string; location: string; bio: string; avatar: string }) => {
        setCurrentUser({
            ...currentUser,
            ...updatedUser,
        });
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            ...
                            <div className="flex flex-wrap gap-3">
                                <button 
                                    ...
                                    className="inline-flex items-center gap-2 rounded-lg bg-warmOrange hover:bg-warmOrange/90 px-6 py-3 font-semibold text-white shadow-lg transition-all hover:scale-105"
                                >
                                ...
                                <button 
                                    ...
                                    className="inline-flex items-center gap-2 rounded-lg bg-white/20 backdrop-blur-sm hover:bg-white/30 px-6 py-3 font-semibold text-white border border-white/30 transition-all"
                                >
                                    <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
